...
class ShallowStackedBidirectionalLSTM(Filter):
    def __init__(self, outputUnits, sampleLength=DEFAULT_SAMPLE_LENGTH, maxWords=DEFAULT_MAX_WORDS, modelName="ShallowStackedBidirectionalLSTM"):
        """
